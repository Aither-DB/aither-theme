(function ($, root, undefined) {
	...
	$(function () {
		...
		$('.title_anim, .position_anim, .qoute_anim, .picture_anim, .line_q_anim, .bar_title_anim, .bar_line_anim, .bar_line_anim_2, .bar_items_anim, .bg_mobile_anim, .title_mobile_anim, .line_mobile_anim, .items_mobile_anim, .slides_bar_anim, .items_anim_1').scroll_anim(0,-100,0);
